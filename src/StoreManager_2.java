...
public class StoreManager_2 extends UnicastRemoteObject implements StoreInterface {
	...
	public StoreManager_2() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub

		try {

			file = new File("magasin_file_2.txt");
